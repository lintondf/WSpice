...
mxArray* mxCreateLogicalScalar( BOOLEAN );
mxArray* mxCreateDoubleMatrix( int, int, int );
mxArray* mxCreateNumericArray( int, int[], int, int );
mxArray* mxCreateCharMatrixFromStrings( int, const char** );
int mxGetNumberOfElements( const mxArray* );
int mxGetN( const mxArray* );
int mxGetM( const mxArray* );
void* mxMalloc( int );
void* mxCalloc( int, int );
void mxFree( void* );
...
#define       A_DBL_RET_ARGV(x)      (SpiceDouble*)((WolframLibraryData) prhs[0])->MTensor_getRealData((MTensor) plhs[x])

#define       A_BOOL_RET_ARGV(x)     (SpiceBoolean*)((WolframLibraryData) prhs[0])->MTensor_getIntegerData((MTensor) plhs[x])

#define       A_INT_RET_ARGV(x)      (SpiceInt*)((WolframLibraryData) prhs[0])->MTensor_getIntegerData((MTensor) plhs[x])
